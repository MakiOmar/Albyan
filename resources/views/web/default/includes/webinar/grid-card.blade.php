    ...
    <figure>
        <div class="image-box">
            ...
            <a href="{{ $webinar->getUrl() }}">
                ...
                @endif
                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="{{ $webinar->getImage() ?: '/assets/default/img/placeholder.svg' }}" class="img-cover" alt="{{ $webinar->title }}" width="375" height="250">
            </a>
