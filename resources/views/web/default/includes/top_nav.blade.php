    ...
    <div id="top-nav-container" class="container d-flex justify-content-between align-items-center flex-lg-row">
        <div class="top-contact-box border-bottom d-flex flex-column flex-md-row align-items-center justify-content-center">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                ...
                {{-- Do not submit global search when query is empty --}}
                <form action="/search" method="get" {!! navbar_search_form_non_empty_submit_attribute() !!} class="form-inline my-2 my-lg-0 navbar-search position-relative" style="min-height: 40px;min-width: 180px;">
                    <input class="blue-bg form-control mr-5 rounded-pill text-white" type="text" name="search" placeholder="{{ trans('navbar.search_anything') }}" aria-label="Search" required style="min-height: 40px; height: 40px; width: 100%;">
