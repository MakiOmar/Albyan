...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="{{ getPageBackgroundSettings('categories') }}" class="img-cover" alt="{{ trans('public.categories_background') }}" width="1200" height="400"/>
