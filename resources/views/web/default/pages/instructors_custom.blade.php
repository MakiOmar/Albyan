...
<div class="container text-center mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-6 col-md-3">
            <a href="/profile/ceo1">
                ...
                <center><strong>راغب قؤاد</strong></center>
            </a>
        </div>
        <div class="col-6 col-md-3">
            <a href="/profile/ceo2">
                ...
                <center><strong>أحمد يونس</strong></center>
            </a>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-4 col-md-2">
            ...
            <center><strong>د. نور</strong></center>
        </div>
        <div class="col-4 col-md-2">
            ...
            <center><strong>د. محمود أبو أميره</strong></center>
        </div>
        <div class="col-4 col-md-2">
            ...
            <center><strong>د. فاطمة</strong></center>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-4 col-md-2">
            ...
            <center><strong>جهاد</strong></center>
        </div>
        <div class="col-4 col-md-2">
            ...
            <center><strong>منار</strong></center>
        </div>
        <div class="col-4 col-md-2">
            ...
            <center><strong>ماريا</strong></center>
        </div>
        <div class="col-4 col-md-2">
            ...
            <center><strong>سميجه</strong></center>
        </div>
        <div class="col-4 col-md-2">
            <a href="/profile/team4">
            ...
            <center><strong>محمود</strong></center>
        </div>
        <div class="col-4 col-md-2">
            <a href="/profile/team4">
