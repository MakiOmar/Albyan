                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            <div class="stat-icon-box teacher">
                                ...
                                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="/assets/default/img/stats/teacher.svg" alt="" class="img-fluid" loading="lazy" decoding="async" width="48" height="48"/>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            <div class="stat-icon-box student">
                                {{-- Placeholder + data-src so deferred image-lazy-loader controls the fetch --}}
                                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="/assets/default/img/stats/student.svg" alt="" class="img-fluid" loading="lazy" decoding="async" width="48" height="48"/>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            <div class="stat-icon-box video">
                                {{-- Placeholder + data-src so deferred image-lazy-loader controls the fetch --}}
                                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="/assets/default/img/stats/video.svg" alt="" class="img-fluid" loading="lazy" decoding="async" width="48" height="48"/>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            <div class="stat-icon-box course">
                                {{-- Placeholder + data-src so deferred image-lazy-loader controls the fetch --}}
                                <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="/assets/default/img/stats/course.svg" alt="" class="img-fluid" loading="lazy" decoding="async" width="48" height="48"/>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                            <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                                <div class="stat-icon-box " style="background-color: {{ $homeCustomStatistic->color }}">
                                    {{-- Placeholder + data-src so deferred image-lazy-loader controls the fetch --}}
                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="{{ $homeCustomStatistic->icon }}" alt="{{ $homeCustomStatistic->title }}" class="img-fluid" loading="lazy" decoding="async" width="48" height="48"/>
                                </div>
