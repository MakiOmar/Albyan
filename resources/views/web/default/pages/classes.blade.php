...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="{{ getPageBackgroundSettings('categories') }}" class="img-cover" alt="{{ trans('public.classes_background') }}" width="1200" height="400"/>
                ...
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="/search" method="get" {!! search_form_non_empty_submit_attribute() !!}>
