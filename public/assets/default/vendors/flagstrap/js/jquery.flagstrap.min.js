...
var r=a("<a/>").attr("data-val",a(this).val()).attr('href', '#').html(i).append(n).on("click",function(e){a(c).val(a(this).data("val")),a(c).trigger("change"),a(".flagstrap-selected-"+s).html(a(this).html()),e.preventDefault()}),l=a("<li/>").prepend(r)
e.append(l)}),e}
