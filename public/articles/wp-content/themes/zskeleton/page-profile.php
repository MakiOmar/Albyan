...
if ( defined( 'ZSKELETON_MEMBERSHIP_PATH' ) && is_readable( ZSKELETON_MEMBERSHIP_PATH . 'templates/page-profile.php' ) ) {
	require ZSKELETON_MEMBERSHIP_PATH . 'templates/page-profile.php';
	return;
}
