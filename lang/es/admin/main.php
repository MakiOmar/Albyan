...
// Settings - SEO
    ...
    'seo_title_hint' => 'Optional. Used as the browser tab title and search result title. Falls back to the category title if empty.',
...
// Settings-main
    ...
    'site_name_locale_hint' => 'El título de la plataforma se guarda por idioma. El resto de ajustes básicos son compartidos.',
...
//Hints & Placeholders
    ...
    'page_custom_assets' => 'Custom page assets',
    'page_custom_assets_hint' => 'Optional CSS, JavaScript, and HTML injected only on this page. Leave empty to use the default layout only.',
    'page_styles' => 'Styles',
    'page_styles_placeholder' => '.my-class { color: #01477d; }',
    'page_styles_hint' => 'CSS rules (auto-wrapped in <style>) or full <style> / <link> tags. Output in the page <head>.',
    'page_scripts' => 'Scripts',
    'page_scripts_placeholder' => 'console.log("page ready");',
    'page_scripts_hint' => 'JavaScript (auto-wrapped in <script>) or full <script> tags. Output before the closing </body>.',
    'page_head_content' => 'Head content',
    'page_head_content_placeholder' => '<meta name="..." content="...">',
    'page_head_content_hint' => 'Extra HTML for <head> (meta tags, preconnect, JSON-LD, etc.).',
    'page_footer_content' => 'Footer content',
    'page_footer_content_placeholder' => '<!-- tracking or widgets -->',
    'page_footer_content_hint' => 'HTML output at the end of <body> after page scripts.',
    'page_content_editor_visual' => 'Visual editor',
    'page_content_editor_html' => 'HTML source',
    'page_content_visual_hint' => 'Rich text editor for simple content (headings, lists, links, images).',
    'page_content_html_hint' => 'Raw HTML — no filtering. Use the Styles tab for CSS. Supports sections, SVG, comments, aria attributes, etc.',
    'page_content_switch_to_visual_title' => 'Switch to visual editor?',
    'page_content_switch_to_visual_warning' => 'The visual editor may remove advanced HTML (sections, SVG, comments, custom attributes). Continue only if you use simple formatting.',
    'page_content_switch_to_visual_confirm' => 'Switch anyway',
    'tools' => 'Herramientas',
    'tools_pages_search_replace' => 'Buscar y reemplazar páginas',
    'tools_database_search_replace' => 'Buscar y reemplazar base de datos',
    'tools_database_backup' => 'Copia de seguridad de la base de datos',
    'database_backup_hint' => 'Crea volcados MySQL completos en el servidor, descárgalos o restaura uno anterior. Restaurar sobrescribe la base de datos en vivo.',
    'database_backup_warning' => 'Restaurar reemplaza permanentemente la base de datos actual con la copia seleccionada. Escribe la frase de confirmación con cuidado. Hazlo solo cuando quieras revertir.',
    'database_backup_path_label' => 'Directorio de copias',
    'database_backup_retention_label' => 'Se conservan las :count copia(s) más recientes',
    'database_backup_create' => 'Crear copia ahora',
    'database_backup_creating' => 'Creando copia…',
    'database_backup_filename' => 'Archivo',
    'database_backup_size' => 'Tamaño',
    'database_backup_modified' => 'Modificado',
    'database_backup_download' => 'Descargar',
    'database_backup_restore' => 'Restaurar',
    'database_backup_empty' => 'Aún no hay copias. Crea una para comenzar.',
    'database_backup_created' => 'Copia :file creada (:size).',
    'database_backup_deleted' => 'Copia :file eliminada.',
    'database_backup_restored' => 'Base de datos restaurada desde :file.',
    'database_backup_delete_title' => '¿Eliminar esta copia?',
    'database_backup_delete_warning' => 'Se eliminará permanentemente',
    'database_backup_restore_title' => '¿Restaurar esta copia?',
    'database_backup_restore_warning' => 'Se sobrescribirá la base de datos en vivo. El sitio entrará en mantenimiento durante la restauración.',
    'database_backup_confirm_label' => 'Escribe :phrase para confirmar',
    'database_backup_confirm_mismatch' => 'La frase de confirmación no coincide.',
    'database_backup_auto_title' => 'Copias automáticas',
    'database_backup_auto_hint' => 'Si está activado, el programador de Laravel crea volcados según el intervalo. El servidor debe ejecutar schedule:run cada minuto.',
    'database_backup_auto_enabled' => 'Activar copias automáticas',
    'database_backup_auto_interval' => 'Intervalo',
    'database_backup_auto_save' => 'Guardar programación',
    'database_backup_auto_saved' => 'Configuración de copia automática guardada.',
    'database_backup_auto_last_run' => 'Última copia automática correcta',
    'database_backup_auto_never_run' => 'Aún no se ha ejecutado ninguna copia automática.',
    'database_backup_auto_last_error' => 'Último error de copia automática',
    'database_backup_interval_hourly' => 'Cada hora',
    'database_backup_interval_every_6h' => 'Cada 6 horas',
    'database_backup_interval_daily' => 'Diario (02:00)',
    'database_backup_interval_weekly' => 'Semanal (lunes 02:00)',
    'db_search_replace_hint' => 'Busca texto en columnas buscables. Usa Dry run para buscar sin modificar nada. Desmarca Dry run para previsualizar y aplicar reemplazos. Se omiten columnas y valores de URL.',
    'db_search_replace_warning' => 'Esta herramienta puede actualizar muchas filas. Se omiten tablas sensibles, credenciales y datos relacionados con URL, pero los cambios no se pueden deshacer. Crea una copia de seguridad primero.',
    'db_search_replace_table' => 'Tabla',
    'db_search_replace_column' => 'Columna',
    'db_search_replace_record_id' => 'ID del registro',
    'db_search_replace_summary' => ':occurrences coincidencia(s) en :records celda(s).',
    'db_search_replace_truncated' => 'Vista previa limitada a las primeras :limit coincidencias. Solo se actualizarán las filas marcadas.',
    'db_search_replace_apply_title' => '¿Aplicar cambios seleccionados en la base de datos?',
    'db_search_replace_apply_warning' => 'Esto actualizará permanentemente solo las filas marcadas. Asegúrate de tener una copia de seguridad.',
    'db_search_replace_preview_required' => 'Ejecuta una vista previa antes de aplicar los cambios.',
    'db_search_replace_applied' => 'Se reemplazaron :occurrences ocurrencia(s) en :records registro(s) de la base de datos.',
    'db_search_replace_dry_run' => 'Dry run (solo búsqueda — sin reemplazo)',
    'db_search_replace_dry_run_hint' => 'Con esto activo no se modifica la base de datos. Solo se listan coincidencias.',
    'db_search_replace_dry_run_badge' => 'Dry run — sin cambios en la base de datos',
    'db_search_replace_search_button' => 'Buscar',
    'db_search_replace_dry_run_apply_blocked' => 'Desactiva Dry run para aplicar reemplazos.',
    'page_tools_search_replace' => 'Buscar y reemplazar',
    'page_search_replace_hint' => 'Busca y reemplaza texto en los campos de las páginas. Previsualiza y selecciona qué actualizar. Las URL dentro del contenido no se modifican.',
    'page_search_replace_search' => 'Buscar',
    'page_search_replace_search_placeholder' => 'Texto a buscar',
    'page_search_replace_replace' => 'Reemplazar con',
    'page_search_replace_replace_placeholder' => 'Dejar vacío para eliminar coincidencias',
    'page_search_replace_pages' => 'Páginas',
    'page_search_replace_all_pages' => 'Todas las páginas',
    'page_search_replace_pages_hint' => 'Dejar vacío para buscar en todas las páginas.',
    'page_search_replace_all_languages' => 'Todos los idiomas',
    'page_search_replace_fields' => 'Campos a buscar',
    'page_search_replace_field' => 'Campo',
    'page_search_replace_case_sensitive' => 'Distinguir mayúsculas',
    'page_search_replace_whole_word' => 'Solo palabra completa',
    'page_search_replace_preview' => 'Vista previa',
    'page_search_replace_apply' => 'Aplicar cambios',
    'page_search_replace_apply_selected' => 'Aplicar seleccionados',
    'page_search_replace_select_required' => 'Selecciona al menos un resultado para aplicar.',
    'page_search_replace_results' => 'Resultados de vista previa',
    'page_search_replace_occurrences' => 'Coincidencias',
    'page_search_replace_snippet' => 'Fragmento',
    'page_search_replace_summary' => ':occurrences coincidencia(s) en :records campo(s).',
    'page_search_replace_no_matches' => 'No se encontraron coincidencias.',
    'page_search_replace_search_required' => 'Introduce el texto que quieres buscar.',
    'page_search_replace_fields_required' => 'Selecciona al menos un campo.',
    'page_search_replace_apply_title' => '¿Aplicar cambios seleccionados?',
    'page_search_replace_apply_warning' => 'Esto actualizará permanentemente solo los campos marcados.',
    'page_search_replace_apply_confirm' => 'Aplicar ahora',
    'page_search_replace_applied' => 'Replaced :occurrences occurrence(s) in :records record(s).',
    'page_search_replace_field_name' => 'Page name',
    'page_search_replace_field_title' => 'Title',
    'page_search_replace_field_seo_description' => 'SEO description',
    'page_search_replace_field_content' => 'Content',
    'page_search_replace_field_styles' => 'Styles',
    'page_search_replace_field_scripts' => 'Scripts',
    'page_search_replace_field_head_content' => 'Head content',
    'page_search_replace_field_footer_content' => 'Footer content',
