...
'db_search_replace_hint' => 'Find and replace text across all searchable database columns. Always preview matches before applying changes.',
'db_search_replace_warning' => 'This tool updates the entire database. Sensitive tables and credential columns are skipped, but changes cannot be undone. Create a backup first.',
...
'db_search_replace_truncated' => 'Preview limited to the first :limit matches. Apply still updates all matching rows in the database.',
'db_search_replace_apply_title' => 'Apply database search & replace?',
'db_search_replace_apply_warning' => 'This will permanently update matching text across the entire database. Preview first and ensure you have a backup.',
...
'page_search_replace_hint' => 'Find and replace text across page fields. Preview matches before applying changes.',
...
'page_search_replace_apply_title' => 'Apply search & replace?',
'page_search_replace_apply_warning' => 'This will permanently update matching page content. Preview first if you are unsure.',
