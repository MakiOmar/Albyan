...
'overlay_opacity_help' => 'Set the opacity of the dark overlay (0-100%)',
'gray_filter_intensity' => 'Gray Filter Intensity',
'gray_filter_intensity_help' => 'Set the intensity of the grayscale filter (0-100%)',
'brightness' => 'Brightness',
'brightness_help' => 'Set the brightness of the image when not hovered',
...
'featured_classes' => 'Most requested courses',
...
'tools' => 'Tools',
'tools_pages_search_replace' => 'Pages Search & Replace',
'tools_database_search_replace' => 'Database Search & Replace',
'tools_database_backup' => 'Database Backup',
'database_backup_hint' => 'Create full MySQL dumps on the server, download them, or restore a previous dump. Restoring overwrites the live database.',
'database_backup_warning' => 'Restore permanently replaces the current database with the selected backup. Type the confirmation phrase carefully. Do this only when you intend to roll back.',
'database_backup_path_label' => 'Backup directory',
'database_backup_retention_label' => 'Keeping the newest :count backup(s)',
'database_backup_create' => 'Create backup now',
'database_backup_creating' => 'Creating backup…',
'database_backup_filename' => 'Filename',
'database_backup_size' => 'Size',
'database_backup_modified' => 'Modified',
'database_backup_download' => 'Download',
'database_backup_restore' => 'Restore',
'database_backup_empty' => 'No backups yet. Create one to get started.',
'database_backup_created' => 'Backup :file created (:size).',
'database_backup_deleted' => 'Backup :file deleted.',
'database_backup_restored' => 'Database restored from :file.',
'database_backup_delete_title' => 'Delete this backup?',
'database_backup_delete_warning' => 'This will permanently remove',
'database_backup_restore_title' => 'Restore this backup?',
'database_backup_restore_warning' => 'This will overwrite the live database. The site will enter maintenance mode during the restore.',
'database_backup_confirm_label' => 'Type :phrase to confirm',
'database_backup_confirm_mismatch' => 'Confirmation phrase does not match.',
'database_backup_auto_title' => 'Automatic backups',
'database_backup_auto_hint' => 'When enabled, the Laravel scheduler creates dumps on the chosen interval. The server must run schedule:run every minute.',
'database_backup_auto_enabled' => 'Enable automatic backups',
'database_backup_auto_interval' => 'Interval',
'database_backup_auto_save' => 'Save schedule',
'database_backup_auto_saved' => 'Automatic backup settings saved.',
'database_backup_auto_last_run' => 'Last successful auto backup',
'database_backup_auto_never_run' => 'No automatic backup has run yet.',
'database_backup_auto_last_error' => 'Last auto-backup error',
'database_backup_interval_hourly' => 'Hourly',
'database_backup_interval_every_6h' => 'Every 6 hours',
'database_backup_interval_daily' => 'Daily (02:00)',
'database_backup_interval_weekly' => 'Weekly (Monday 02:00)',
'db_search_replace_hint' => 'Search the database for text across searchable columns. Use Dry run to search without changing anything. Uncheck Dry run to preview and apply replacements. URL columns and URL values are skipped.',
'db_search_replace_warning' => 'This tool can update many database rows. Sensitive tables, credential columns, and URL-related data are skipped, but changes cannot be undone. Create a backup first.',
'db_search_replace_table' => 'Table',
'db_search_replace_column' => 'Column',
'db_search_replace_record_id' => 'Record ID',
'db_search_replace_summary' => ':occurrences match(es) across :records cell(s).',
'db_search_replace_truncated' => 'Preview limited to the first :limit matches. Only checked rows will be updated.',
'db_search_replace_apply_title' => 'Apply selected database changes?',
'db_search_replace_apply_warning' => 'This will permanently update only the checked rows. Ensure you have a backup.',
'db_search_replace_preview_required' => 'Run a preview before applying changes.',
'db_search_replace_applied' => 'Replaced :occurrences occurrence(s) in :records record(s) across the database.',
'db_search_replace_dry_run' => 'Dry run (search only — no replace)',
'db_search_replace_dry_run_hint' => 'When enabled, the database is not modified. Matches are listed for review only.',
'db_search_replace_dry_run_badge' => 'Dry run — no database changes',
'db_search_replace_search_button' => 'Search',
'db_search_replace_dry_run_apply_blocked' => 'Turn off Dry run to apply replacements.',
'page_tools_search_replace' => 'Search & Replace',
'page_search_replace_hint' => 'Find and replace text across page fields. Preview matches, then select which ones to update. URLs inside content are left unchanged.',
'page_search_replace_search' => 'Search for',
'page_search_replace_search_placeholder' => 'Text to find',
'page_search_replace_replace' => 'Replace with',
'page_search_replace_replace_placeholder' => 'Leave empty to delete matches',
'page_search_replace_pages' => 'Pages',
'page_search_replace_all_pages' => 'All pages',
'page_search_replace_pages_hint' => 'Leave empty to search all pages.',
'page_search_replace_all_languages' => 'All languages',
'page_search_replace_fields' => 'Fields to search',
'page_search_replace_field' => 'Field',
'page_search_replace_case_sensitive' => 'Case sensitive',
'page_search_replace_whole_word' => 'Whole word only',
'page_search_replace_preview' => 'Preview',
'page_search_replace_apply' => 'Apply changes',
'page_search_replace_apply_selected' => 'Apply selected',
'page_search_replace_select_required' => 'Select at least one result to apply.',
'page_search_replace_results' => 'Preview results',
'page_search_replace_occurrences' => 'Matches',
'page_search_replace_snippet' => 'Snippet',
'page_search_replace_summary' => ':occurrences match(es) across :records field(s).',
'page_search_replace_no_matches' => 'No matches found for the current criteria.',
'page_search_replace_search_required' => 'Enter the text you want to search for.',
'page_search_replace_fields_required' => 'Select at least one field to search.',
'page_search_replace_apply_title' => 'Apply selected changes?',
'page_search_replace_apply_warning' => 'This will permanently update only the checked page fields.',
'page_search_replace_apply_confirm' => 'Apply now',
...
'category_courses_mode' => 'Display mode',
'category_courses_mode_recent' => 'Recently added courses in category',
'category_courses_mode_specific' => 'Specific courses',
'category_courses_select_webinars' => 'Select courses',
...
'site_faqs' => 'Site FAQs',
'new_site_faq' => 'New FAQ',
'edit_site_faq' => 'Edit FAQ',
'site_faq' => 'Site FAQ',
'answer' => 'Answer',
